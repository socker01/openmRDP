...
public final class OpenmRDPServerAPIImpl implements OpenmRDPServerAPI {
    ...
    public OpenmRDPServerAPIImpl() {
        ...
        messageService = new MessageService(new MessageSenderImpl(), new MessageReceiverTestImpl());
    ...
    @Override
    public void receiveMessages() throws NetworkCommunicationException, AddressSyntaxException {
